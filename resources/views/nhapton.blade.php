...
<div class="br-mainpanel pos-relative">
    ...
    <div class="tab1">
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <div class="row">
                <h4 class="tx-gray-800 mg-b-5 col-md-6 tx-uppercase">Nhập tồn</h4>
                        ...
                        <div class="modal-dialog" role="document" style="max-width:none;width: 80em;">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title tx-gray-900" >Tạo phiếu nhập tồn từ file excel</h5>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control fc-datepicker" name="date" readonly="" value="<?php echo date("d/m/Y"); ?>" placeholder="MM/DD/YYYY">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 mg-t-10">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i
                                                                ...
                                                                name="" readonly placeholder="Set time">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mg-t-10">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <input type="text" readonly="" value="0.00" id="totalImportExcel" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="br-pagebody pd-x-20 pd-sm-x-30">
                        <div class="shadow-base bg-white pd-15">
                            ...
                            <div class="row tx-gray-900 mg-t-20">
                                ...
                                <div class="col-md-6 row" style="display: flex;">
                                    <div class="col-md-8">
                                ...
                                <div class="mg-t-20">
                                    ...
                                    <table class="table table-bordered tx-13 tx-gray-700 mg-b-0 bd" id="data-table1" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="bg-primary" style="color: white;max-width: 5%">#</th>
                                                <th scope="col" class="bg-primary" style="color: white;max-width: 12%">Mã phiếu</th>
                                                <th scope="col" class="bg-primary" style="color: white;max-width: 12%">Thời gian</th>
                                                <th scope="col" class="bg-primary" style="color: white;max-width: 15%">Tổng tiền</th>
                                                <th scope="col" class="bg-primary" style="color: white;max-width: 20%">Ghi chú</th>
                                                <th scope="col" class="bg-primary" style="color: white;max-width: 15%">Trạng thái</th>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-dialog" role="document" style="max-width:none;width:80%;">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="" id="thongTinNhaCungCap">
...
<div class="br-pagebody pd-x-20 pd-sm-x-30">
    <form id="submitnhapton">
        <div class="shadow-base bg-white pd-15">
            <div class="mg-b-20">
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i
                                                    class="fa fa-clock-o tx-16 lh-0 op-6"></i></span>
                                                    <input id="tpBasic" type="text" class="form-control hour" id="hourImport" value="<?php
                                                    date_default_timezone_set("Asia/Ho_Chi_Minh");
                                                    echo date("H:i:s");?>" name="hour"
                                    ...
                                    <div class="col-md-3 mg-t-10">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="totalPrice" placeholder="0.00" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mg-t-10">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="totalDiscount" placeholder="0.00"
                                                disabled>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mg-t-10">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <textarea name="note" id="editNote" cols="30" rows="1"
                                    ...
                                    <div class="col-md-3 mg-t-10">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" placeholder="0.00" class="form-control" id="totalVAT" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mg-t-10">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" id="totalMoney" placeholder="0.00" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="shadow-base bg-white pd-15 mg-t-25">
                        <div>
                            <label for="browser" class="tx-gray-900 tx-bold">Thêm hàng hoá vào
                            phiếu</label>
                            <div class="pos-relative">
                                <input autocomplete="off" id="autoSearchImage" class="form-control"
                                placeholder="Tìm kiếm hàng hoá theo mã vạch hoặc tên">
                    ...
                    <div class="modal-dialog" role="document" style="max-width: none;width: 80%;vertical-align: top;">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title tx-gray-900" id="exampleModalLabel">Tìm kiếm nâng cao
                                </h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#daChon">Đã
                                        chọn</a>
                                    </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content">
                                    <div id="timKiem" class="tab-pane active"><br>
                                        <label for="" id="dsdulieu2" class="tx-bold tx-gray-800"></label>
                                        <table class="table table-bordered tx-13 tx-gray-700 mg-b-0 bd"
                                        id="data-table2" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th scope="col" class="bg-primary" style="color: white;">Mã HH
                                                </th>
                                            ...
                                            <th scope="col" class="bg-primary" style="color: white;">Số ĐK
                                            </th>
                                            <th scope="col" class="bg-primary" style="color: white;">Quy
                                            cách đóng gói</th>
                                            <th scope="col" class="bg-primary" style="color: white;">Hãng
                                            sản xuất</th>
                                            <th scope="col" class="bg-primary" style="color: white;"> Hoạt
                                            chất chính</th>
                                        </tr>
                                    </thead>
                                </table>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="submitHangHoa2">Xong</button>
                <button type="button" class="btn btn-danger" data-dismiss="modal">Đóng</button>
            </div>
        </form>
    </div>
...
<div class="shadow-base bg-white pd-15 mg-t-25">
    <div style="overflow-x: auto;">
        <label for="" id="info-data-table3" class="tx-bold tx-gray-800"></label>
        <table class="table table-bordered tx-13 tx-gray-700 mg-b-0 bd" id="data-table3" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="bg-primary"
                    style="color:white;min-width:150px;width:18%;text-align:center">Tên HH</th>
                    <th scope="col" class="bg-primary"
                    ...
                    <th scope="col" class="bg-primary"
                    style="color:white;min-width:100px;width:9%;text-align:center">Tổng giảm giá</th>
                    <th scope="col" class="bg-primary"
                    style="color:white;min-width:60px;width:4%;text-align:center">VAT(%)</th>
                    <th scope="col" class="bg-primary"
...
<div class="d-flex justify-content-end  mg-t-15">
    <button type="submit" class="btn btn-primary mg-r-10 submitPhieuNhap">
        <i class='far fa-save' style='font-size:13px;padding:2px'></i>
        Lưu
    </button>
    <button class="btn btn-danger" id="outTab2"><i class="fa fa-reply" style="font-size:13px"
        ...
        <form action="" id="nhapTuNhaCUngCap" name="nhapTuNhaCUngCap" method="POST">
            ...
            <div class="modal-body pd-t-0">
                ...
                <div class="row mg-t-10">
                    <div class="col-md-12">
                        <label for="" class="tx-gray-800 tx-bold">Ghi chú</label>
                        <textarea disabled="disabled" name="" id="detailnote" cols="30" rows="1"
                        class="form-control"></textarea>
                    </div>
                </div>
                <div class="mg-t-10">
                    ...
                    <table id="data-table4" class="table table-bordered tx-13 tx-gray-700 mg-b-0 bd">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="bg-primary" style="color: white;width:15%">Tổng giảm giá</th>
                                <th scope="col" class="bg-primary" style="color: white;width:8%">Tổng VAT</th>
                                <th scope="col" class="bg-primary" style="color: white;width:15%">Thành tiền</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger font-weight-bold text-uppercase" data-dismiss="modal">
        ...
        <form action="" id="formThanhToan">
            <div class="modal-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#danhSachIn" role="tab"
                        aria-controls="profile" aria-selected="false">Danh sách in</a>
                    </li>
                </ul>
                                ...
                                <table class="table table-bordered tx-13 tx-gray-700 mg-b-0 bd">
                                    <thead>
                                        <tr>
                                            ...
                                            type="checkbox"></th>
                                            <th scope="col" class="bg-primary" style="color: white;width: 8%;">Mã HH
                                            </th>
                                            <th scope="col" class="bg-primary" style="color: white;width: 20%;">Tên
                                            </th>
                                            <th scope="col" class="bg-primary" style="color: white;width: 20%;">Đơn
                                            vị tính</th>
                                            <th scope="col" class="bg-primary" style="color: white;width: 8%;">Loại
                                            </th>
                                            <th scope="col" class="bg-primary" style="color: white;width: 10%;">Số
                                            ĐK</th>
                                            <th scope="col" class="bg-primary" style="color: white;width: 16%;">Quy
                                            cách đóng gói</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                    ...
                    <div class="row mg-t-10">
                        <div class="col-md-6">
                            <table class="table table-bordered tx-13 tx-gray-700 mg-b-0 bd">
                                <thead>
                                    <tr>
                                        <th scope="col" class="bg-primary" style="color: white;width: 12%;">Mã
                                        HH</th>
                                        <th scope="col" class="bg-primary" style="color: white;width: 25%;">Tên
                                        </th>
                                        <th scope="col" class="bg-primary" style="color: white;width: 15%;">Đơn
                                        vị tính</th>
                                        <th scope="col" class="bg-primary" style="color: white;width: 15%;">Giá
                                        bán</th>
...
$('#searchByStock').typeahead({
    ...
    highlighter: function (item, data) {
        ...
        html += '<div>SĐK: <strong>'+data.reg_no+'</strong> | Mã HH: <strong>HH0000'+checkRangeValue(data.id)+'</strong></div>';
...
function loadData(){
    ...
    DataTable_hanghoa.forEach(item=>{
      $('#data-table3').DataTable().row.add([
        ...
        '<input style="width:70%;border:0;background:none" data-name="price_import" data-id="'+index+'" onchange="updateData(this)" class="form-control" value="'+new Intl.NumberFormat('en-US',{style: "decimal", minimumFractionDigits: 2, maximumFractionDigits:2}).format(price_import(DataTable_hanghoa[index]['qty'] || 0,DataTable_hanghoa[index]['price'] || 0,DataTable_hanghoa[index]['discount'] || 0,DataTable_hanghoa[index]['VAT'] || 0))+'" disabled />',
        '<input style="width:100%;border:0;background:none" data-name="total" data-id="'+index+'" onchange="updateData(this)" class="form-control" value="'+new Intl.NumberFormat('en-US',{style: "decimal", minimumFractionDigits: 2, maximumFractionDigits:2}).format(total(DataTable_hanghoa[index].qty || 0,DataTable_hanghoa[index].price || 0,DataTable_hanghoa[index].discount || 0,DataTable_hanghoa[index].VAT || 0))+'" disabled />',
...
$('#totalMoney').val(new Intl.NumberFormat('en-US',{style: "decimal", minimumFractionDigits: 2, maximumFractionDigits:2
}).format(sum(sumTotal)));
var sumDiscount = $("input[data-name='discount']")
.map(function(){return replaceCurrency($(this).val());}).get();
$('#totalDiscount').val(new Intl.NumberFormat('en-US',{style: "decimal", minimumFractionDigits: 2, maximumFractionDigits:2
}).format(sum(sumDiscount)));
...
$('#totalPrice').val(new Intl.NumberFormat('en-US',{style: "decimal", minimumFractionDigits: 2, maximumFractionDigits:2
}).format(sum(sumArr)));
...
$('#totalVAT').val(new Intl.NumberFormat('en-US',{style: "decimal", minimumFractionDigits: 2, maximumFractionDigits:2
}).format(tempMoney-tempPrice+tempDiscount));
    ...
    var table1 = $('#data-table1').DataTable({
        ...
        { data: null,
           "render": function(data,type,row) {
            if(data["id"]<10){
             return "PNT00000"+data["id"]
         }else if(data["id"]<100){
             return "PNT0000"+data["id"]
         }else{
             return "PNT000"+data["id"]
         }
     }
 },
...
{ data: null, orderable: false,
   "render": function(data,type,row) {
    ...
    return new Intl.NumberFormat('en-US').format(data["total"])}
}
},
...
{
    extend: 'excelHtml5',
    title: 'PhieuNhapTon_'+new Date().toLocaleDateString()+'_'+new Date().toLocaleTimeString(),
        ...
        select: function (event, ui) {
         ...
         $.ajax({
            ...
            success: function(response) {
              ...
              var i=0;
              response.forEach(item=>{
                $("input[data-name='exchange'][data-id='"+i+"']").attr('disabled', true);
                $("select[data-name='unit'][data-id='"+i+"']").attr('disabled', true);
                i++;
            })
          }
      });
...
if(haCheck==0){
    $.ajax({
      url: "{{ url('nhapton/submitnhapton') }}",
      type: "POST",
      data: $('#submitnhapton').serialize()+"&totalpaid="+replaceCurrency($('#totalPaid').val()),
      success: function( response ) {
        DataTable_hanghoa.forEach(item => {
            item.type = "import_inventory"
        ...
        $.ajax({
            ...
            success: function( ress ) {
                ...
                $.ajax({
                  url: "{{ url('nhapton/submitphieunhap') }}",
                  type: "POST",
                  dataType:'json',
                  contentType: 'json',
                  data: JSON.stringify(DataTable_hanghoa),
...
function detailFunc(id){
    $.ajax({
      type:"GET",
      url: "{{ url('nhapton/edit') }}",
      data: { id: id },
      dataType: 'json',
      success: function(res){
        $('#labelChiTietPhieuNhap').html('Phiếu nhập tồn - PN'+checkRangeValue(res.id));
        $('#detailid').val("PNT"+checkRangeValue(res.id));
        $('#detailname').val(res.name);
        $('#detaildate').val(res.date);
        $('#detailnote').val(res.note);
            // $('#detailprice').val(res.price)
            console.log(res);
        }
    });
    ...
    $.ajax({
      ...
      success: function(response){
         var table4 = $('#data-table4').DataTable({
            ...
            { data: null,
                "render": function(data,type,row) {
                    return new Intl.NumberFormat('en-US',{style: "decimal", minimumFractionDigits: 2, maximumFractionDigits:2}).format(data['price'])}
                },
                { data: null,
                    "render": function(data,type,row) {
                ...
                { data: null,
                    ...
                    { data: null,
                        "render": function(data,type,row) {
                            return new Intl.NumberFormat('en-US',{style: "decimal", minimumFractionDigits: 2, maximumFractionDigits:2}).format(data['VAT'])}
                        },
                        { data: null,
...
function editFunc(id){
    $.ajax({
      ...
      dataType: 'json',
      success: function(res){
        $('#labelTaoMoiPhieuNhap').html(`Nhập tồn > Sửa phiếu: PNT${checkRangeValue(res.id)}`);
        $('#id').val(res.id);
        $('#dateImport').val(res.date);
        $('#tpBasic').val(res.hour);
			...
			$.ajax({
				...
				success: function(response){
					...
					mywindow.document.write(`
						...
						<p style="text-align:center"><strong>PHIẾU NHẬP TỒN</strong></p>
...
function changeFunc(id) {
    Swal.fire({
        title: 'Cảnh báo!',
        title: "Bạn chắc chắn muốn huỷ phiếu này PNT"+checkRangeValue(id)+ "?",
        icon: 'warning',
        ...
        if (result.value) {
            $.ajax({
                ...
                success: function(res) {
                    $("#data-table1").load(
                        $.toast({
                            text: "Tạm dừng hoạt động nhập tồn",
                            position: "bottom-right",
                            icon: "success",
                            stack: 1,
                            loader: false
...
<script>
    ...
    function haChange(){
      ...
      let VAT = $('#VAT').val();
      $('#thanhTien').val(new Intl.NumberFormat('en-US').format(total(qty || 0,price || 0,discount || 0,VAT || 0)));
    ...
    new AutoNumeric(".VAT_sell", {
        ...
        unformatOnHover: false
            ...
            $("#inTab2").click(function() {
                ...
                $('#labelTaoMoiPhieuNhap').html("Nhập tồn > Tạo mới");
            })

            let taoMoiPhieuNhapTon = $("#taoMoiPhieuNhapTon");
            if (taoMoiPhieuNhapTon.length) {
                taoMoiPhieuNhapTon.validate({
                    rules: {
                        date: {
                            required: true
                        },
                    ...
                    messages: {
                        date: {
                            required: 'Vui lòng điền ngày nhập tồn'
                        },
                        time: {
                            required: 'Vui lòng điền thời gian thời gian nhập tồn'
                        }
                    }
                })
            }
                ...
                $.ajax({
                    ...
                    success: function( ress ) {
                        ...
                        $.ajax({
                            ...
                            success: function( data ) {
                                $('#data-table1').DataTable().ajax.reload();
                                toastr.success('Thêm mới phiếu nhập tồn từ excel thành công');
