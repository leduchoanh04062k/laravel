<div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="overflow:hidden">
    ...
    <a class="dropdown-item" onClick="khoaTaiKhoan({{ $id }} , 1)" href="#"><i class="fas fa-user-minus"></i> Khóa tài khoản</a>
    <a class="dropdown-item" onClick="deleteFunc({{ $id }})" href="#"><i class="fas fa-user-times"></i> Xóa tài khoản</a>
  </div>
