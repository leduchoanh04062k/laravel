<div class="dropdown">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="overflow: hidden;">
        ...
        <!-- Button thanh toán -->
        <button type="button" onClick="editFuncdebt({{ $id }})" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#thanhToan">
            <i class="far fa-money-bill-alt"></i>
            Thanh toán
        </button>
        <!-- Button công nơj -->
        <button type="button" onClick="editFuncdebt({{ $id }})" class="btn btn-primary dropdown-item"
            data-toggle="modal" data-target="#congNo">
            <i class="far fa-money-bill-alt"></i>
            Điều chỉnh công nợ
        </button>
