@extends('default')
@section('title','Báo cáo doanh thu theo ca làm việc')
@section('content')
<div class="br-mainpanel pos-relative">
    ...
    <div id="tab1">
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <div class="row">
                <h4 class="tx-gray-800 mg-b-5 col-6 tx-uppercase">Báo cáo doanh thu theo ca làm việc</h4>
                    ...
                    <table class="table table-bordered tx-13 tx-gray-700 mg-b-0 bd" id="data-table1" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="bg-primary" style="color: white;">Ca làm việc</th>
    ...
    $(document).ready(function () {
      ...
      "order": [[ 1, "desc" ]],
        ...
        "ajax": {
          type:"GET",
          url : "{{ url('bcdoanhthucalamviec/money') }}",dataType : "json",
        },
        "columns": [
          { data: 'id', name: 'id'},
              { data: null,
        ...
        { data: null,
          ...
          { data: null, orderable: false,
            "render": function(data,type,row) {
              return decialNumber((data['totalMoney'] - data['totalpaid'])+(data['discounts']-data['sales']))
            }
          },
          ],
          columnDefs: [
          ...
          $.extend(true, {}, xlsBuilder, {
                extend: 'excelHtml5',
                title: 'BaoCaoDoanhThuTheoCaLamViec_'+new Date().toLocaleDateString()+'_'+new Date().toLocaleTimeString(),
            ...
            "render":function(data,type,row){
              if(data['type']=='sell'){
                ...
                return "HD" +checkRangeValue(data['id']);
                  ...
                  return "PXT" +checkRangeValue(data['id']);
                }
              }else if (data['type']=='return_from_customer'){
                return "PXT" +checkRangeValue(data['cusId']);
              }else{
                return ""
              }
            }
        ...
        "render": function(data,type,row) {
          ...
          { data: null,
           "render":function(data){
            if(data['type']=='sell'){
                if(data['nameSell']==null){
                    return decialNumber(data['Prices_import']);
                }else{
                    return decialNumber(data['Prices_import']);
                }
              }else if (data['type']=='return_from_customer'){
          ...
          { data: null,
            'render':function(data,type,row){
               if(data['type']=='sell'){
                ...
                return decialNumber(parseInt(data['totalpaid']) + parseInt(data['discount']));
              }else{
                return "0.00"
              }
    ...
    .draw();
      ...
      var table4 = $('#data-table4').DataTable({
        ...
        "ajax": {
          type:"GET",
          url : "{{ url('bcdoanhthucalamviec/bill') }}",dataType : "json",
        },
        "columns": [
          { data: 'id', name: 'id'},
          { data: null,
    ...
    customize: function(xlsx) {
      ...
      var r3 = Addrow(3, [{
        k: 'C',
        v: 'BÁO CÁO DOANH THU THEO CA LÀM VIỆC:'
      }
      ]);
    //   var r4 = Addrow(4, [{
    //     k: 'C',
