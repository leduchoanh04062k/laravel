@extends('default')
@section('title','Nhóm nhà cung cấp')
@section('content')
<div class="br-mainpanel">
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30 d-flex justify-content-between">
        <h4 class="tx-gray-800 mg-b-5 tx-uppercase">Nhóm nhà cung cấp</h4>
        <div class="d-flex">
            <div class="mg-r-10">
                    ...
                    <div class="modal-dialog" role="document" style="max-width:none;width:50em;vertical-align: top;">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title tx-gray-900" id="exampleModalLabel">Thêm nhóm nhà cung cấp</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="" id="themNhaCungCap" method="post">
                                @csrf
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 pt-3">
                                            <label for="" class="tx-gray-800 tx-bold">Tên nhóm nhà cung cấp <span
            ...
            <div class="mg-r-10">
                ...
                <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document" style="max-width:none;width:80em;vertical-align: top;">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title tx-gray-900" id="exampleModalLabel">Nhập nhóm nhà cung cấp từ
                                    file excel</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <form action="" id="importExcelForm" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                <th scope=" col" class="bg-primary"
                                                                    style="color: white;">Tên nhóm nhà cung cấp</th>
                                                                <th scope="col" class="bg-primary"
                                                                    style="color: white;">Ghi chú
                                                                </th>
                                                                <th scope="col" class="bg-primary"
                                                                    style="color: white;">Trạng
                                                                    thái</th>
                                                                <th scope="col" class="bg-primary"
                                                                    style="color: white;">Lỗi
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                ...
                                <div class="modal-body" style="border-top:1px solid #e9ecef;padding-top:8px">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            <em class="iconImportBulb"></em>
                                            <span class="text-dark font-weight-bold">Tải file
                                                excel
                                                mẫu <a href="{{ url('./download/fileMauNhomNhaCungCap.xlsx') }}">tại
                                                    đây</a>
                                            </span>
                                        </div>
                                        <div class="col-sm-3">
                                            <button type="button" class="btn btn-primary mg-r-6" id="submitImport">
                                                <em class="fa fa-save"></em> Lưu hàng hoá
                                            </button>
        ...
        <div class="modal fade" id="chiTiet" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document" style="max-width: none;width: 50em;vertical-align: top;">
                <div class="modal-content">
                    ...
                    <form action="" id="suaNhaCungCap" method="post">
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
            ...
            <div class="row tx-gray-900">
                ...
                <div class="col-md-5">
                    ...
                    <input id="searchBySupplier" type="text" class="form-control"
                        placeholder="Tìm kiếm theo mã nhà cung cấp hoặc tên nhà cung cấp">
                </div>
                ...
                <table id="data-table1" class="table table-bordered tx-13 tx-gray-700 mg-b-0 bd" style="width: 100%">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="bg-primary" style="color: white;max-width:20%">Tên nhóm nhà cung cấp
                            </th>
...
<script>
  ...
  $(document).ready(function () {
    ...
    var table1 = $('#data-table1').DataTable({
      ...
      ajax: {
        url: "{{ url('nhomnhacungcap') }}",
      },
      columns: [
      { data: 'id', name: 'id',orderable:false},
      { data: null,orderable:false,
        "render": function(data,type,row) { return "NNCC"+checkRangeValue(data["id"])}
      },
      ...
      dom: 'Blfrtip',
          ...
          $.extend(true, {}, {
                extend: 'excelHtml5',
                title: 'NhomNhaCungCap'+new Date().toLocaleDateString()+'_'+new Date().toLocaleTimeString(),
  ...
  function editF(id){
    $.ajax({
      type:"GET",
      url: "{{ url('nhomnhacungcap/{id}/edit') }}",
      data: { id: id },
      dataType: 'json',
      success: function(res){
        $('#id').val(res.id);
  ...
  function changeFunc(id){
    Swal.fire({
      title: 'Cảnh báo!',
      text: "Bạn chắc chắn muốn ngừng hoạt động NHCC0000"+id+" này?",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
  ...
  function unChangeFunc(id){
    Swal.fire({
      title: 'Cảnh báo!',
      text: "Bạn chắc chắn muốn kích hoạt NHCC0000"+id+" trở lại?",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      ...
      if (result.value) {
        $.ajax({
          type:"POST",
          url: "{{ url('nhomnhacungcap/unactive') }}",
          data: { id: id },
          dataType: 'json',
          success: function(res){
            $("#changeF").modal('hide');
...
<script>
    ...
    $(document).ready(function () {
      ...
      $(function () {
        let suaNhaCungCap = $("#suaNhaCungCap");
        if (suaNhaCungCap.length) {
          suaNhaCungCap.validate({
            rules: {
              name: {
                required: true
              }
      ...
      $(function () {
        let themNhaCungCap = $("#themNhaCungCap");
        if (themNhaCungCap.length) {
          themNhaCungCap.validate({
            ...
            submitHandler: function(form) {
              ...
              $.ajax({
                ...
                document.getElementById("themNhaCungCap").reset();
              }
            });
            }
          })
     ...
     $('#submitImport').click(function(){
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '{{ url('nhomnhacungcap/insertDataExcel') }}',
