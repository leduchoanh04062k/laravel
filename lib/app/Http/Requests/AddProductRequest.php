...
class AddProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'accessories'=>'required|unique:vp_products,prod_accessories',
            'price'=>'required|unique:vp_products,prod_price',
            'promotion'=>'required|unique:vp_products,prod_promotion',
            'condition'=>'required|unique:vp_products,prod_condition',
            'description'=>'required|max:305|min:15|unique:vp_products,prod_description',
             'img'=>'image'
        ];
    }
