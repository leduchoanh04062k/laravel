...
<title>@yield('title') |Thế giới điện thoại</title>
...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="{{asset('admin/home')}}">LÊ ĐỨC HOÀNH</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="{{asset('admin/slider')}}"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-star"></use></svg>Slider</a></li>
			<li><a href="{{asset('admin/user')}}"><svg class="glyph stroked line-graph"><use xlink:href="#stroked-male-user"></use></svg>User</a></li>
			<li role="presentation" class="divider"></li>
		</ul>
