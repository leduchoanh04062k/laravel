			...
			location.reload();
					...
					<div id="wrap-inner">
						<div id="list-cart">
							...
							<form>
								<table class="table table-bordered .table-responsive text-center">
									...
									<tr>
										<td><img class="img-responsive" width="100px" src="{{asset('lib/storage/app/avatar/' . $item->options->img)}}"></td>
										<td>{{$item->name}}</td>
										<td>
										...
										<td><a href="{{asset('cart/delete/'.$item->rowId)}}"class="my-btn btn">Xóa</a></td>
									</tr>
									@endforeach
								</table>
						...
						<div id="xac-nhan">
							...
							@else
							<h5 style="color:#07fa46">Giỏ hàng của bạn rỗng mời bạn thêm sản phẩm vào giỏ hàng</h5>
							@endif
						</div>
					</div>
